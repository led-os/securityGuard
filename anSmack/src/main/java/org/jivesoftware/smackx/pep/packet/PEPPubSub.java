...
//        buf.openElement("publish").attribute("node", item.getNode()).rightAngleBracket();// delete by liukuan
        buf.halfOpenElement("publish").attribute("node", item.getNode()).rightAngleBracket();// add by liukuan
