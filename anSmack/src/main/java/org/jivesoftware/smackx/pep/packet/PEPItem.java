...
public abstract class PEPItem implements ExtensionElement {
    ...
    String id;
    public abstract String getNode();// default modifier change to public by liukuan
    public abstract String getItemDetailsXML();// default modifier change to public by liukuan
