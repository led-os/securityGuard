...
public class CommUtil {
	...
	static public String encBase64Url(byte[] plainData) {
		return Base64.encodeToString(plainData, Base64.URL_SAFE);
		//return Base64Coder.encode(plainData);
	}

	static public byte[] decBase64Url(String cyperText) {
		return Base64.decode(cyperText,Base64.URL_SAFE);
		//return  Base64Coder.decode(cyperText);
	}
